...
const UpdateProduct = () => {
  ...
  const getSingleProduct = async () => {
    try {
      ...
      setIsOnSale(data.product.isOnSale);
      setsalePrice(data.product.salePrice);
      setSaleStartDate(data.product.saleStartDate);
      setSaleEndDate(data.product.saleEndDate);
    } catch (error) {
      console.log(error);
    }
  };
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      productData.append("isOnSale", !!isOnSale);
